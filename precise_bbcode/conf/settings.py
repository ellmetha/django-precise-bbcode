...
BBCODE_URL_NOFOLLOW = getattr(settings, 'BBCODE_URL_NOFOLLOW', False)
_BBCODE_NOFOLLOW = getattr(settings, '_BBCODE_NOFOLLOW', ' rel="nofollow"' if BBCODE_URL_NOFOLLOW else '')
